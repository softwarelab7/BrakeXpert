        ...
        <div className="login-overlay">
            <div className="login-card">
                <div className="login-header">
                    <h2 className="admin-logo-title" style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', gap: 0, color: '#fff', fontSize: '2rem', fontWeight: 800 }}>
                        <span>Brake</span>
                        ...
                        <span style={{ marginLeft: '10px', color: '#9ca3af', fontWeight: 400 }}>Admin</span>
                    </h2>
